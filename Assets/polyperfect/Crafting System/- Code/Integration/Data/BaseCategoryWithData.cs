...
namespace PolyPerfect.Crafting.Integration
{
    ...
    {
        public abstract object ConstructDictionary();
    }
    ...
    public abstract class BaseCategoryWithData<T> : BaseCategoryWithData
    {
        ...
        public override object ConstructDictionary()
        {
        ...
        public override VisualElement CreateInlineEditor(BaseObjectWithID obj, string label)
        {
            ...
            pf.Bind(so);
            pf.Q<Label>(className: BaseField<int>.labelUssClassName)?.RemoveFromHierarchy();
