...
namespace EmeraldAI.Utility
{
    public class EmeraldAILookAtController : MonoBehaviour
    {
        ...
        {     
            ...
            EmeraldComponent.AIAnimator.SetLookAtWeight(LookWeight, UnityBodyIK, EmeraldComponent.HeadLookWeightCombat);
