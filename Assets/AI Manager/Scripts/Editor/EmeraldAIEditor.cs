...
namespace EmeraldAI.Utility
{
    ...
    public class EmeraldAIEditor : Editor
    {
        ...
        void OnEnable()
        {
            ...
            MovingTurningSpeedCombatProp = serializedObject.FindProperty("MovingTurningSpeedCombat");
            ...
            AgentTurnSpeedMovingProp = serializedObject.FindProperty("MovingTurningSpeedNonCombat");
        ...
        public override void OnInspectorGUI()
        {
            ...
            else if (self.FactionRelationsList.Count == 0 && self.BehaviorRef != EmeraldAISystem.CurrentBehavior.Pet)
            {
                GUI.backgroundColor = new Color(10f, 0.0f, 0.0f, 0.25f);
            ...
            {
                GUI.backgroundColor = new Color(10f, 0.0f, 0.0f, 0.25f);
                EditorGUILayout.HelpBox("It looks like this AI's Animator's Controller has gone missing. This can happen if you resaved an Animator Controller that is shared with another AI. Emerald AI can attempt to recover this using the last saved path. However, if the previous Animator Controller's path has changed, " +
            ...
            if (TabNumberProp.intValue == 1)
            {
                ...
                if (TemperamentTabNumberProp.intValue == 1)
                {
                    ...
                    CustomEditorProperties.CustomFloatSlider(new Rect(), new GUIContent(), AgentTurnSpeedMovingProp, "Moving Turn Speed", 30, 2500);
                    ...
                    CustomEditorProperties.CustomIntSlider(new Rect(), new GUIContent(), MovingTurningSpeedCombatProp, "Moving Combat Turn Speed", 5, 2500);
            ...
            if (TabNumberProp.intValue == 2)
            {
                ...
                if (DetectionTagsTabNumberProp.intValue == 0)
                {
                    ...
                    CustomHelpLabelField("The layers that should be ignored when an AI is using its obstruction detection for attacking with melee and ranged attacks. " +
                        ...
                        "set the layermask to Everything.", true);
                    ...
                    if (GUILayout.Button("Regenerate Animator Controller", RegenerateButtonStyle))
                    {
                        ...
                        foreach (GameObject G in Selection.gameObjects)
                        {
                            if (G.GetComponent<EmeraldAISystem>() != null)
                            {
                                ...
                                Debug.Log(EmeraldComponent.name + "'s Animator Controller has been regenerated.");
        ...
        void OnSceneGUI()
        {
            ...
            if (self.DetectionTypeRef == EmeraldAISystem.DetectionType.LineOfSight && TabNumberProp.intValue == 2 && DetectionTagsTabNumberProp.intValue == 0)
            {
                ...
                {
                    Handles.DrawSolidArc(self.HeadTransform.position, self.transform.up, self.transform.forward, self.fieldOfViewAngle / 2, (float)self.DetectionRadius);
                    Handles.DrawSolidArc(self.HeadTransform.position, self.transform.up, self.transform.forward, -self.fieldOfViewAngle / 2, (float)self.DetectionRadius);
                }
                else
                {
