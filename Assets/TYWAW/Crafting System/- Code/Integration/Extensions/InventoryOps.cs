...
namespace PolyPerfect.Crafting.Integration
{
    public static class InventoryOps
    {
        ...
        /// </summary>
        public static List<ItemStack> ExtractPossibleFromCollection<T>(IList<T> source, IEnumerable<ItemStack> toExtract) where T:IExtract<Quantity, ItemStack>
        {
        ...
        /// </summary>
        public static bool CanInsertCollectionCompletely<T>(IEnumerable<ItemStack> source, IList<T> destination) where T : IInsert<ItemStack>, IPeek<ItemStack>
        {
        ...
        /// </summary>
        public static List<ItemStack> RemainderAfterInsertCollection<T>(IEnumerable<ItemStack> source, IList<T> destination) where T : IInsert<ItemStack>, IPeek<ItemStack>
        {
